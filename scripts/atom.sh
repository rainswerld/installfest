...
if which apm; then
  apm install aligner aligner-scss aligner-css aligner-javascript atom-beautify \
  ...
  linter-rubocop linter-tidy tidy-html5 \
  markdown-writer sort-lines intentions linter-sass-lint \
  standardjs-snippets open-in-browser emmet pigments
  atom .
